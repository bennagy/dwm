...
static const char *vim[]  = { "st", "vim", "new.", NULL };
static const char *tt[]  = { "st", "tt", "--showwpm", NULL };
static const char *links[]  = { "st", "links", "duckduckgo.com", NULL };
static const char *pavucontrol[]  = { "st", "pavucontrol", NULL };
static const char *htop[]  = { "st", "htop", NULL };
static const char *screenshot[]  = { "st", "scrot", "-s", NULL };
static const char *obs[]  = { "obs", NULL };
static const char *upvol[] = { "amixer", "sset", "Master", "3%+", NULL };
static const char *downvol[] = { "amixer", "sset", "Master", "3%-", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_t,      spawn,          {.v = tt } },
	{ MODKEY|ShiftMask,             XK_d,      spawn,          {.v = links } },
